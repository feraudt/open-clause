...
ERC1410.deploy(ERC20FixedSupply[0].address, 1, {'from':acc0})
...
# account#9 s'enregistre sur le contract ERC1410
ERC1410[0].registerAccount({'from':acc9})
ERC1410[0].holders(acc9)
### out : (0, 0)
...
ERC1410[0].isControllable()
### out : 1 (TRUE)

# Enregistrement de account#9 comme Controller
ERC1410[0].registerController(acc9)
ERC1410[0].holders(acc9)
### out : (0,1)
...
# au préalable, Alice (account#1) autorise le contract ERC1410 à débiter son compte d'au moins 4 tokens
ERC20FixedSupply[0].approve(ERC1410[0].address, 5, {'from':acc1})
ERC20FixedSupply[0].balanceOf(acc1)
### out : 20
ERC20FixedSupply[0].allowance(acc1, ERC1410[0].address)
...
ERC1410[0].controllerTransfer(acc2, acc1, 4, 5678, {'from':acc9})
...
# au préalable, le Controller (account#9) autorise le contract ERC1410 à débiter son compte d'au moins 4 tokens
ERC20FixedSupply[0].approve(ERC1410[0].address, 5, {'from':acc9})
ERC1410[0].controllerRedeem(acc1, 4, 5678, {'from':acc9})
