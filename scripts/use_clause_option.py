...
#	- pour le bénéficiaire Bob (account#2)
#	- au prix d'exercice de 3 tokens (>= au montant de 3 tokens de la partition)
#	- le coût de l'option est de 1 tokens
...
# -> dans la durée des cinq jours, Bob refuse l'achat de la partition
# Bob indique son refus sur le contract d'option
clauseOption[0].recipientDeny(5678, {'from':acc2})

ERC1400[0].partitions(5678)
### out : ("0xF800DeBE778aA16295AEF005db9c85aD4293DfA0", 3, 1606861940, 0)

ERC20FixedSupply[0].balanceOf(acc2)
### out : 15 (16 - priceOption)
